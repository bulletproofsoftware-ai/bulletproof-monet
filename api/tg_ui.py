...
def send_document(chat_id, doc_url, caption=""):
    """Send a URL as a document (no recompression).

    Telegram recompresses sendPhoto images; a tall full-page screenshot comes
    back ~391px wide and unreadable. sendDocument preserves the original.
    """
